//! OpenAI chat-completions wire types (SPEC §8.1) and validation into the
//! worker-protocol request shape. Unknown top-level fields are ignored, like
//! the reference implementation; unsupported *features* are rejected with
//! clear 400s rather than silently dropped.
